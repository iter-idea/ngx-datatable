...
DatatableComponent.ɵcmp = i0.ɵɵngDeclareComponent({
  ...
  components: [
    {
      type: i4.DataTableHeaderComponent,
    ...
    {
      type: i5.DataTableBodyComponent,
    ...
    {
      type: i6.DataTableFooterComponent,
  ...
  directives: [
    { type: i7.VisibilityDirective, selector: '[visibilityObserver]', outputs: ['visible'] },
    { type: i8.NgIf, selector: '[ngIf]', inputs: ['ngIf', 'ngIfThen', 'ngIfElse'] }
  ],
  pipes: { async: i8.AsyncPipe },
