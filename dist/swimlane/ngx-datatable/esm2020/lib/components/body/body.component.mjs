...
DataTableBodyComponent.ɵcmp = i0.ɵɵngDeclareComponent({
  ...
  components: [
    ...
    {
      type: i6.DataTableBodyRowComponent,
  ...
  directives: [
    ...
    { type: i7.NgStyle, selector: '[ngStyle]', inputs: ['ngStyle'] }
  ],
