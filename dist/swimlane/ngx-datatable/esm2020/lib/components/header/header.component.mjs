...
DataTableHeaderComponent.ɵcmp = i0.ɵɵngDeclareComponent({
  ...
  components: [
    {
      type: i1.DataTableHeaderCellComponent,
  ...
  directives: [
    { type: i2.OrderableDirective, selector: '[orderable]', outputs: ['reorder', 'targetChanged'] },
    { type: i3.NgForOf, selector: '[ngFor][ngForOf]', inputs: ['ngForOf', 'ngForTrackBy', 'ngForTemplate'] },
    { type: i3.NgStyle, selector: '[ngStyle]', inputs: ['ngStyle'] },
    {
      type: i4.ResizeableDirective,
      selector: '[resizeable]',
